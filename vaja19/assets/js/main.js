function PreveriSestevek() {
    var x = parseInt(document.getElementById("steviloX").value);
    var y = parseInt(document.getElementById("steviloY").value);
    var r = parseInt(document.getElementById("sestevek").value);
